...
class HeadlineCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        locator<NavigationHandler>().pushNamed(BlogContentViewRoute, arg: post);
      },
      child: Container(
        margin: active ? EdgeInsets.zero : EdgeInsets.symmetric(vertical: 8.h),
        height: 140.h,
